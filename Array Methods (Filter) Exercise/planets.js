...
// Filter planets based on habitability criteria
const habitablePlanets = planets
    .filter(planet => planet.temperature >= 253 && planet.temperature <= 323 && planet.distance >= 0.75 && planet.distance <= 1.5)
    .map(planet => planet.name);

// Print the names of habitable planets
